...
----
include::{pipeline-solutions}/07-Jenkinsfile-agents[]
----
...
[source,groovy,subs="attributes"]
----
include::{pipeline-solutions}/08-Jenkinsfile-parallel-tests[]
----
...
[source,groovy,subs="attributes"]
----
include::{pipeline-solutions}/09-Jenkinsfile-dockerfile-agents[]
----
